...
@interface JTCalendarDayView (){
    ...
    JKBarView *circleView;
    UILabel *textLabel;
    JKDumbbellView *dotView;
...
- (void)configureConstraintsForSubviews
{
  ...
  //TODO: replace dotView with a dumbbell image.
    dotView.frame = CGRectMake(0, 0, sizeDot, sizeDot);
    dotView.center = CGPointMake(self.frame.size.width / 2,
                                 (self.frame.size.height / 2) + sizeCircle / 2);
